...
# Clipped to our download window 2013-01-01 – 2025-04-11.
DJIA_SPELLS = [
    # Continuous members throughout the full download window
    ('MMM',  '2013-01-01', '2025-04-11'),
    ('AXP',  '2013-01-01', '2025-04-11'),
    ('BA',   '2013-01-01', '2025-04-11'),
    ('CAT',  '2013-01-01', '2025-04-11'),
    ('CVX',  '2013-01-01', '2025-04-11'),
    ('CSCO', '2013-01-01', '2025-04-11'),
    ('KO',   '2013-01-01', '2025-04-11'),
    ('DIS',  '2013-01-01', '2025-04-11'),
    ('HD',   '2013-01-01', '2025-04-11'),
    ('IBM',  '2013-01-01', '2025-04-11'),
    ('JNJ',  '2013-01-01', '2025-04-11'),
    ('JPM',  '2013-01-01', '2025-04-11'),
    ('MCD',  '2013-01-01', '2025-04-11'),
    ('MRK',  '2013-01-01', '2025-04-11'),
    ('MSFT', '2013-01-01', '2025-04-11'),
    ('PG',   '2013-01-01', '2025-04-11'),
    ('TRV',  '2013-01-01', '2025-04-11'),
    ('UNH',  '2013-01-01', '2025-04-11'),
    ('VZ',   '2013-01-01', '2025-04-11'),
    ('WMT',  '2013-01-01', '2025-04-11'),
    # Removed 2013-09-23: replaced by GS, NKE, V
    ('AA',   '2013-01-01', '2013-09-22'),
    ('BAC',  '2013-01-01', '2013-09-22'),
    ('HPQ',  '2013-01-01', '2013-09-22'),
    # Added 2013-09-23
    ('GS',   '2013-09-23', '2025-04-11'),
    ('NKE',  '2013-09-23', '2025-04-11'),
    ('V',    '2013-09-23', '2025-04-11'),
    # AT&T removed 2015-03-19 (replaced by AAPL)
    ('T',    '2013-01-01', '2015-03-18'),
    ('AAPL', '2015-03-19', '2025-04-11'),
    ...
    # Added 2020-08-31
    ('AMGN', '2020-08-31', '2025-04-11'),
    ('HON',  '2020-08-31', '2025-04-11'),
    ('CRM',  '2020-08-31', '2025-04-11'),
    # INTC removed 2024-11-08 (replaced by NVDA)
    ('INTC', '2013-01-01', '2024-11-07'),
    ('NVDA', '2024-11-08', '2025-04-11'),
    # SHW added 2024-11-08 (replaced DOW)
    ('SHW',  '2024-11-08', '2025-04-11'),
]
